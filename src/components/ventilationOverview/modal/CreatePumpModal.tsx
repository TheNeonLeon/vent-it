...
function CreatePumpModal() {
  ...
  return (
    <>
      <button
        className="bg-violet-700 rounded-xl text-white active:bg-pink-600 font-bold uppercase text-sm px-6 py-3 shadow hover:shadow-lg outline-none focus:outline-none mr-1 mb-1 ease-linear transition-all duration-150"
        type="button"
